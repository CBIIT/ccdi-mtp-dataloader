...
./load_cancerbiomarker.sh http://ftp.ebi.ac.uk/pub/databases/opentargets/platform/21.06/output/etl/json/
./load_diseases.sh
./load_disease_hpo.sh
./load_drugs.sh
./load_eco.sh   http://ftp.ebi.ac.uk/pub/databases/opentargets/platform/21.06/output/etl/json/
./load_evidences.sh
...
#./load_otars.sh
./load_reactome.sh
#./load_so.sh  //http://ftp.ebi.ac.uk/pub/databases/opentargets/platform/21.06/output/
./load_targets.sh
